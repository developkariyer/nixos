# Temporary local package definition for Antigravity 1.18.3
# Remove this file once the upstream flake (jacopone/antigravity-nix) catches up.
# Based on: https://github.com/jacopone/antigravity-nix/blob/master/package.nix
{ lib
, stdenv
, fetchurl
, buildFHSEnv
...
let
  ...
  src = fetchurl {
    ...
    sha256 = "sha256-xGeNs24UwQCKGp4d3tj7jYdurqSXkmjYQF6f2Vwckm4=";
  };
